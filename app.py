...
# 2. Мәліметтер базасы (Нақты ұстаздар мен көрнекі суреттер)
teachers_data = [
...
if section == "Басты бет":
    ...
    # Мектеп ғимаратының көрнекі суреті
    st.image("https://unsplash.com", caption="«Кешкі мектеп» КММ тарихи шежіресі", use_container_width=True)
    
elif section == "Басшылық":
    st.subheader("👤 Мектеп басшылығы")
    col1, col2 = st.columns([1, 2])
    with col1:
        # Директор профилінің көрнекі суреті
        st.image("https://unsplash.com", caption="Мектеп басшысы", use_container_width=True)
    with col2:
    ...
    # Ұстаздар галереясының көрнекі суреті
    st.image("https://unsplash.com", caption="Ұстаздар ұжымы", use_container_width=True)
    ...
    # Оқушылардың көрнекі суреті
    st.image("https://unsplash.com", caption="Мектеп белсенділері", use_container_width=True)
    
    # Интерактивті кесте және іздеу
    ...
    # Виртуалды қабылдау бөлмесі суреті
    st.image("https://unsplash.com", caption="Виртуалды қабылдау бөлмесі", use_container_width=True)
